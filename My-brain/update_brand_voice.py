...
def add_brand_voice_details():
    ...
    details = [
        ...
        ("Từ vựng hay dùng", "'thật ra', 'đơn giản thôi', 'thử xem', 'không cần phức tạp', xưng tên 'Cherry', 'mình', 'cả nhà', 'hông có', 'đúng hem?', dùng icon theo cảm xúc."),
        ...
        ("Ví dụ bài mẫu tiêu chuẩn", "Tết này uống cafe ngon, nhất định thử cafe đặc sản nha ❤️❤️\nQuay cuồng cùng vị nhà, Cherry chưa kịp báo cả nhà Tết nay nhà Cherry có cà phê đặc sản rồi đó. Cafe được chính tay bố quế mẹ liên làm, cả nhà chong đèn ngồi lựa từng hạt chín hạt xanh. Những mẻ này gần như chín tuyệt đối nên sẽ ấn tượng lắm đó cả nhà nha ☺️ xịn ạ\nCà phê thơm lắm, chưa kịp khui mà hương đã ngây ngất rồi. Cà phê được lên men nên sẽ có khá nhiều hương trái cây đó cả nhà, thú vị lắm, thơm lừng hít lấy hít để thôi, hậu ngọt kéo dài, chua nhẹ, mượt lắm.\nCherry đang sẵn để giao ngay trước Tết. Cherry mời cả nhà nha")
    ]
